...
# # # Modified regular expression to capture temperature details
# # matches = re.findall(r"Temperature: Min (\S+) °C \| Max (\S+) °C", weather_info)
# # if matches:
# #     min_temp, max_temp = matches[0]
# #     print(f"Min Temperature: {min_temp}°C")
# #     print(f"Max Temperature: {max_temp}°C")

# # # You can modify and add more patterns for other details like rainfall, humidity, wind speed, etc.


# # # You can add more patterns for other details like rainfall, humidity, wind speed, etc.
...
#     # Return Predictions
#     print("This is  the air qualittyy ", air_quality_predictions["predictions"])
#     return {
